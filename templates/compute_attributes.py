...
compute_attributes = """
{
    ...
    "redfish.v1": {
        ...
        "@odata.id": "/redfish/v1",
        "Id": "RootService",
        "Name": "Seahawk System Root Service",
    ...
    "redfish.v1.Systems.1": {
        ...
        "ID": "1",
        "Name": "Seahawk Compute Node",
        "SystemType": "Physical",
        "Manufacturer": "HPE",
        "Model": "Seahawk",
        "Description": "Seahawk Compute Node",
        "HostName": "seahawknode_r1c1b1s1",
    ...
    "redfish.v1.UpdateService": {
        ...
        "@odata.id": "/redfish/v1/UpdateService",
        "Name": "Update Service",
        "Description": "Seahawk Node Update Service",
        "Id": "UpdateService",
        "Status": {
    ...
    "redfish.v1.Fabrics.GenZ.Endpoints.{ENDPOINTS}": {
        ...
        "Id": "1",
        "Name": "Seahawk Node Fabric Adapter",
